...
## Directories
dir_prep = 'D:\\Study_61\\R_DMCR_OHI\\github\\toolbox-demo\\prep' 
dir_cw   = file.path(dir_prep, 'CW')
dir_layers = 'D:\\Study_61\\R_DMCR_OHI\\github\\toolbox-demo\\region2017\\layers'
...
```{r}
write_csv(mean_months_summer, file.path(dir_layers, "cw_mean_secchi_region2016_1.csv"))
```
